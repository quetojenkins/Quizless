...
button10_clicked = False
button11_clicked = False
button12_clicked = False
button13_clicked = False
...
# MENU BAR CODE TO ACCESS
	...
	if button7_clicked:
		...
		ques,ans,num,found = qna.get_next(q,a,d)
		card_text = ques
		button7_clicked = False # allow it to be clicked again
		time.sleep(0.1)
	...
	if button8_clicked:
		...
		ques,ans,num,found = qna.get_next(q,a,d)
		card_text = ques
		button8_color = (46,181,115)
		button8_clicked = False # allow it to be clicked again
		time.sleep(0.1)
	...
	if button9_clicked:
		...
		ques,ans,num,found = qna.get_next(q,a,d)
		card_text = ques
		button9_color = (46,181,115)
		button9_clicked = False # allow it to be clicked again
		time.sleep(0.1)
	
	if button10_clicked:
		q,a,d = qna.initialise("FileHandeling Section/qnas/chapter10.txt")
		ques,ans,num,found = qna.get_next(q,a,d)
		card_text = ques

		button10_color = (46,181,115)
		button10_clicked = False # allow it to be clicked again
		time.sleep(0.1)	
	if button11_clicked:
		q,a,d = qna.initialise("FileHandeling Section/qnas/chapter11.txt")
		ques,ans,num,found = qna.get_next(q,a,d)
		card_text = ques
		button11_color = (46,181,115)
		button11_clicked = False # allow it to be clicked again
		time.sleep(0.1)
	if button12_clicked:
		q,a,d = qna.initialise("FileHandeling Section/qnas/chapter12.txt")
		ques,ans,num,found = qna.get_next(q,a,d)
		card_text = ques
		button12_color = (46,181,115)
		button12_clicked = False # allow it to be clicked again
		time.sleep(0.1)
